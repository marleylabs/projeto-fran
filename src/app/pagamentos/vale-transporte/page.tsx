...
import { Button, DeletionModal, FileInput, buttonClassName, useToast, type FileInputStatus } from "@/components/ui";
...
<div>
<Link href="/pagamentos" className="text-sm font-semibold text-primary">← Contas a pagar</Link>
<h1 className="mt-4 text-2xl font-bold">Vale Transporte</h1>
<p className="text-sm text-secondary">Rateio por Empresa → Departamento → Colaborador · Maranhão (MA).</p>
</div>
<Summary maps={maps}/>
